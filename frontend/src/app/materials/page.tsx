      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="p-6 lg:p-8 space-y-6 overflow-y-auto max-w-6xl mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            {/* Action */}
            <button className="px-4 py-2.5 rounded-xl bg-[#22352a] hover:bg-[#2e4739] text-white font-bold text-xs flex items-center gap-2 shadow-sm transition-colors">
                ...
                >
                  ...
                  <div className="mt-5 pt-3 border-t border-[#f0ece1] flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      {/* Ask RAG Agent Button - Passes document title to /chat?q=... */}
                      <Link
                        href={`/chat?q=Ask+Knowledge+Agent+about+${encodeURIComponent(doc.title)}`}
                        className="px-3 py-1.5 rounded-lg bg-[#22352a] text-white hover:bg-[#2e4739] text-xs font-bold transition-colors shadow-sm"
                      >
                        Ask RAG Agent
                      </Link>
                      <button
